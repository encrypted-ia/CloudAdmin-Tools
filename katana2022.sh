...
# ------------------------
sudo nmap -sC -sV -O -T2 -Pn -vvv -oN corte0_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -sC -sV -O -T2 -Pn -p- -vvv -oN corte1_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -p- -T2 -Pn -vvv -oN corte2_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -sT -p- -T2 -Pn -vvv -oN corte3_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -sC -sV -T2 -Pn -vvv -oN corte4_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -sU -T2 -Pn -vvv -oN corte5_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap --script vuln -T2 -Pn -vvv -oN corte6_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap -sA -T2 -Pn -vvv -oN corte7_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap --traceroute -T2 -Pn -vvv -oN corte8_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap --script auth -T2 -Pn -vvv -oN corte9_preciso.txt 127.0.0.1
sleep 5
...
# ------------------------
sudo nmap --script discovery -T2 -Pn -vvv -oN corte10_preciso.txt 127.0.0.1
sleep 5
